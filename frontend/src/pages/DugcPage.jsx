...
const RequestsCardView = ({ onViewDetails }) => {
  ...
  return (
    <div>
      <h2 style={{ marginBottom: '20px', fontWeight: 700 }}>OUTSTATION GATEPASS REQUESTS (DUGC)</h2>
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        {/* Office Secretary Decision Info */}
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
        <h2 style={{ fontWeight: 700, margin: 0 }}>GATEPASS HISTORY (DUGC)</h2>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        {gatepasses.map((gp) => (
          <div
            key={gp._id}
            style={{
              background: gp.stageStatus?.dugc?.status === 'approved'
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span style={{
                fontWeight: 700,
                fontSize: '12px',
                color: gp.stageStatus?.dugc?.status === 'approved' ? '#16a34a' : '#dc2626',
              }}>
                {gp.stageStatus?.dugc?.status === 'approved' ? 'PASSED TO HOD' : 'REJECTED'}
              </span>
            </div>
